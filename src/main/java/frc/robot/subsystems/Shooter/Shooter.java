...
public class Shooter extends SubsystemBase {
  ...
  public Shooter() {
    ...
    ZonesList[4] = new ZoneAnalogPosition(Zones.PARTY,  3.8,          1.00);//.8

    ZonesList[5] = new ZoneAnalogPosition(Zones.GREEN_FLAT,   2.71,     0.44);
    ZonesList[6] = new ZoneAnalogPosition(Zones.YELLOW_FLAT,  3.11,   1);
    ZonesList[7] = new ZoneAnalogPosition(Zones.BLUE_FLAT,    3.9,    1); //.8 .66
    ZonesList[8] = new ZoneAnalogPosition(Zones.RED_FLAT,     3.85,    1);//.75
